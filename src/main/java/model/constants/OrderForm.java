...
public class OrderForm {
    ...
    //путь для выбора станции метро из выпадающего списка станций метро
    public static final By INPUT_CONTAINER_METRO_SOKOLNIKY = By.xpath("//*[@id='root']/div/div[2]/div[2]/div[4]/div/div[2]/ul/li[4]/button/div[2]");
    public static final By INPUT_CONTAINER_METRO_LENINLIBRARY = By.xpath("//*[@id='root']/div/div[2]/div[2]/div[4]/div/div[2]/ul/li[10]/button/div[2]");
